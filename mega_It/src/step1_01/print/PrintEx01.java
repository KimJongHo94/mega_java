...
// 2) 주석(comment) : 설명문을 작성하기 위한방법 , 프로그램의 실행에 영향을 미치지 않는다.
...
public class PrintEx01 {
	...
	public static void main(String[] args) { // main메서드의 {}안에서 프로그래밍을 한다.
	
		// tab으로 들여쓰기를 한 이후 코드를 작성한다.
		
		// System.out.println(데이터) : 1) 데이터를 (console)화면에 출력한다. 2) 줄을 바꾼다(개행)
		System.out.println("===========");
		...
		//System.out.print(데이터) : 1) 데이터를 (console)화면에 출력한다.
