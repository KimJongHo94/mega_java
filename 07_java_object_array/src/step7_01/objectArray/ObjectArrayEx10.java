...
public class ObjectArrayEx10 {
	...
	public static void main(String[] args) {
		...
		// <E> 제네릭 
		// 어레이리스트는 메서드를 무조건 사용해서 사용해야 한다.
		ArrayList<Integer> list = new ArrayList<Integer>();		// 0개 시작
		...
		// 크기(arr)  : 10
		System.out.println("크기(arr)  : " + arr.length);
		
		// 크기(list) : 5
		System.out.println("크기(list) : " + list.size());
		...
		// arr  : [1000, 2000, 3000, 40, 50, 0, 0, 0, 0, 0]
		System.out.println("arr  : " + Arrays.toString(arr));
		...
		// ArrayList 지우는 방법
		list.clear();		// ArrayList의 모든 데이터만 삭제(비운다)
		
		list.add(10);
		// list : [10]
		System.out.println("list : " + list);
		
		list = null;		// ArrayList 자체를 삭제(진짜 지운다)
//		list = new ArrayList<Integer>(); // 새롭게 선언 후 사용해야 한다.
//		list.add(10);
