...
public class ExceptionEx01 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(testArr[999]); // 배열 범위 초과 대응(로깅,백업,복구,전파)
			//System.out.println(testArr[0] / 0); // 연산 오류 대응(로깅,백업,복구,전파)
		}
		catch (ArrayIndexOutOfBoundsException e) {
			System.out.println("배열 범위 초과 대응(로깅,백업,복구,전파)");
			e.printStackTrace();
			/*
			 * java.lang.ArrayIndexOutOfBoundsException: Index 999 out of bounds for length 5
	       at step5_01.exception.ExceptionEx01.main(ExceptionEx01.java:28)
			 * 
			 * */
		}
