...
public class ArrayEx01 {
	...
	public static void main(String[] args) {
		...
		// 2. 주소 변수(주소, 참조 저장)
		int[] arr = null; // 주소변수의 초기값은 null을 대입한다.
		arr = new int[5];
		
		System.out.println(arr); // [I@69a3d1d (배열의 이름은 주소(참조))
		
		System.out.println(arr[0]); // 배열의 요소(element)는 초기값이 지정되어 있다.
		...
		// 초기값으로 다시 대입하여 데이터를 삭제한다. (reset 개념으로 생각하기)
		arr[3] = 0;
		arr[4] = 0;
