...
# 8) '부서이름 별로' 그룹화하여 급여의 평균을 구하기 (EMPLOYEES , DEPARTMENTS , DEPT_EMP , SALARIES)
        
		
		
# 9) '직함별로' 그룹화하여 급여의 평균을 구하기 (TITLES , SALARIES)
...
# 13) '부서이름별로' 그룹화하고 '직책별로' 그룹화하여 부서이름과 직원수를 조회하기 (TITLES , EMPLOYEES , DEPT_EMP , DEPARTMENTS)
