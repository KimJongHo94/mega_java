...
# 12) '상품이름별'로 그룹화하여 2020년 동안 판매된 수량(내림차순)순으로 정렬하여 상품이름 , 상품판매량 조회하기.



# 13) '지역별'로 그룹화하여 판매량이 많은 순서대로 정렬하여 지역명과 판매량 조회하기.
...
# 16) '상품 코드별'로 그룹화하여 상품코드 , 판매금액 총합을 판매급액이 많은 순으로 조회하기. 
