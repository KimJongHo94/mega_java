...
public class V2C_param {
	...
	public String requestParam(@RequestParam("titleId") long titleId, @RequestParam("tab") String tab, @RequestParam("no") int no) {
	...
	public String pathVariable(@PathVariable("titleId") long titleId, @PathVariable("tab") String tab, @PathVariable("no") int no) {
