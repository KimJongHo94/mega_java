...
//	@PostMapping("/modelAttribute222") // 1) 404 (not found)
//	@GetMapping("/modelAttribute")     // 405 (method -> get, post 불일치)
	@PostMapping("/modelAttribute")
	public String modelAttribute(@ModelAttribute ProductDTO productDTO, @RequestParam("isPC") boolean isPC, @RequestParam("locationId") long locationId, @RequestParam("lang") String lang) { // 400(Bad Request : 파라메타 불일치)
		...
		return "redirect:/v2c";        // 2) 404 (not found)
	}
