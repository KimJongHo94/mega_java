...
//		request.getRequestDispatcher("jsp경로");
		RequestDispatcher dis = request.getRequestDispatcher("chapter06_servlet/servletEx01.jsp"); // webapp 하위 경로부터 작성한다.
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("chapter06_servlet/servletEx01Action.jsp"); // webapp 하위 경로부터 작성한다.
		dis.forward(request, response);
