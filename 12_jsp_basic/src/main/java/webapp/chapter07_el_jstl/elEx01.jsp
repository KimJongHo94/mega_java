...
<body>
	...
	<h3>자바의 변수 표기</h3>
	<p>${name}</p> <!-- 원래모습 : ${requestScope.name } -->
	<p>${num1}</p> <!-- 원래모습 : ${requestScope.num1 } -->
	<p>${num2}</p> <!-- 원래모습 : ${requestScope.num2 } -->
	<hr>
	...
	<h3>배열형 데이터 타입</h3>
	<p>${list1 == null }</p>     <!-- 생성x -->
	<p>${empty list2 }</p>       <!-- 생성o, 데이터x (empty는 변수 앞 뒤 구분 상관 안함) -->
	<p>${not empty list2 }</p>
	<p>${empty list3 }</p>
	<p>${not empty list3 }</p>   <!-- 생성o, 데이터o (empty는 변수 앞 뒤 구분 상관 안함) -->
	<p>${list3 }</p>
