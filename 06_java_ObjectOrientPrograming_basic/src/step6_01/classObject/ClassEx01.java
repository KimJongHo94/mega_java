...
class Member { // 클래스의 이름은 대문자로 작성한다.
	...
	// 속성
	// property(프로퍼티), field(필드), 멤버, 멤버변수
	String id;
	String password;
	String name;
	String email;
...
public class ClassEx01 {
	...
	public static void main(String[] args) {
		...
		member1.name = "자바킹";
		member1.email = "test@naver.com";
		member1.hp = "010-1111-2222";
		member1.address = "서울";
		
		System.out.println("member1객체");
		System.out.println(member1);		// step6_01.classObject.Member@2a556333
