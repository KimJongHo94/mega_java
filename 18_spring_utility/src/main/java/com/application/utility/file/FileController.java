...
public class FileController {
	...
	@Value("${file.repo.path}") // org.springframework.beans.factory.annotation.Value
...
//		System.out.println("content type : " + upFile.getContentType());
	...
	*/
	...
	public String deleteFile(@RequestParam("deleteFileName") String deleteFileName) {
		
		// 파일을 삭제한다.
		//new File(fileRepositoryPath + deleteFileName).delete();
	...
	public String updateFile(@RequestParam("deleteFileName") String deleteFileName, @RequestParam("modifyFile") MultipartFile modifyFile) throws IllegalStateException, IOException {
